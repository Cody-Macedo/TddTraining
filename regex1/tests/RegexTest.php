...
final class RegexTest extends TestCase
{
    ...
    public function testEx10(): void
    {
        $regex = Regex::ex10();
        $this->assertMatchesRegularExpression($regex, '0033618373993');
        $this->assertMatchesRegularExpression($regex, '0618373993');
        $this->assertMatchesRegularExpression($regex, '+33618373993');
        $this->assertDoesNotMatchRegularExpression($regex, 'eaezr+33618373993');
//        $this->assertDoesNotMatchRegularExpression($regex, '00033618373993');
//        $this->assertDoesNotMatchRegularExpression($regex, '0003333333333618373993');
    }
}
